  ...
  return (
    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl'>
        ...
        >
          <img src={logo} alt='logo' className='w-64 h-16 object-contain cursor-pointer' />
          <br />
          {/*  <p className='text-[#7fdbff] text- [18px] font-bold cursor-pointer '>Samson Molou&nbsp;
            <span className='sm:block hidden text-white text-[16px] font-light'>Technology Consultant <br /> Senior RPA Developer</span>
          </p> */}
        </Link>
